...
func NewGoCdkStack(scope constructs.Construct, id string, props *GoCdkStackProps) awscdk.Stack {
	...
	myTable := awsdynamodb.NewTable(stack, jsii.String("myUsersTable"), &awsdynamodb.TableProps{
	...
	myTable.GrantReadWriteData(myLambdaFunction)

	myApiGateway := awsapigateway.NewRestApi(stack, jsii.String("myAPIGateway"), &awsapigateway.RestApiProps{
	...
	lambdaIntegration := awsapigateway.NewLambdaIntegration(myLambdaFunction, nil)
